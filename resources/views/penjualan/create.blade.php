    ...
    <form action="{{ route('penjualan.store') }}" method="POST">
        ...
        <div class="row mb-3">
            <div class="col-md-12 mb-3">
                ...
                <input id="ppn" type="number" name="ppn" class="form-control ppn" placeholder="PPN" value="{{$ppn}}">
            </div>
            ...
            <div class="col-md-12 mb-3">
                ...
                <input id="bayar" type="number" name="bayar"  class="form-control" placeholder="Bayar" min=0>
            </div>
        </div>
        <div class="row mb-3">
            <div class="col-md-12 mb-3">
                <label for="kembalian">Kembalian:</label>
                <input id="kembalian" type="number" name="kembalian"  class="form-control" placeholder="Kembalian" min=0>
            </div>
        </div>
        <div class="row mb-3">
